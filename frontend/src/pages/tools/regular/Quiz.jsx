    ...
    return (
      <ToolLayout>
        <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
          ...
          <div className="text-sm" style={{ color: "rgba(148,163,184,0.5)", fontFamily: "'JetBrains Mono', monospace" }}>
    ...
    return (
      <ToolLayout>
        <div className="flex items-center justify-center min-h-[60vh]">
          <p className="text-sm" style={{ color: "rgba(148,163,184,0.5)" }}>No quiz questions available.</p>
        </div>
      </ToolLayout>
    );
  }
        ...
        <div className="max-w-xl mx-auto py-10">
          ...
          >
            ...
            <div
              ...
              style={{ color: grade.color, fontFamily: "'JetBrains Mono', monospace" }}
            >
              {pct}%
            </div>
            <div className="text-2xl font-bold text-white mb-1">{grade.label}</div>
            <div className="text-sm mb-6" style={{ color: "rgba(148,163,184,0.5)" }}>
  ...
  return (
    <ToolLayout>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-end justify-between">
            ...
            >
              ...
              <div className="text-xs" style={{ color: "rgba(148,163,184,0.4)" }}>SCORE</div>
            </div>
          </div>
        </div>
        ...
        {/* Progress */}
        <div className="mb-6">
          <div className="flex justify-between text-xs mb-2" style={{ fontFamily: "'JetBrains Mono', monospace", color: "rgba(148,163,184,0.4)" }}>
        ...
        >
          <div className="flex items-start gap-4 mb-7">
            ...
            <h2 className="text-lg font-semibold text-white leading-relaxed mt-1">
              {question?.question}
            </h2>
          </div>
                ...
                <button
                  ...
                  onMouseLeave={(e) => {
                    if (!revealed) {
                      ...
                      e.currentTarget.style.background = "rgba(2,11,24,0.7)";
                    }
                  }}
                >
                  <span
        ...
        {showExplanation && (
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-semibold tracking-wider" style={{ color: "#60a5fa", fontFamily: "'JetBrains Mono', monospace" }}>
                EXPLANATION
              </span>
            </div>
        ...
        <div className="flex justify-end">
          <button
            ...
            style={{
              background: showExplanation ? "linear-gradient(135deg, #1d4ed8, #0369a1)" : "rgba(7,14,34,0.6)",
              border: "1px solid rgba(96,165,250,0.3)",
              color: "#fff",
            }}
          >
